...
BEGIN
  ...
  -- Create a system user for avatar memories if it doesn't exist
  ...
  (jonathan_id, system_user_id, 'I''m Jonathan Braden, a Canadian-American entrepreneur, designer, and adventurer with deep empathy and a love for history. I thrive in creative and intellectual spaces and enjoy meaningful conversations.', 
  ...
  (jonathan_id, dummy_user_id, 'I live in Sofia, Bulgaria where I explore the old city, have morning espresso rituals at local cafés, and take weekend hikes on Vitosha Mountain.',
