...
export async function POST(request: Request) {
  ...
  // Ensure factbook is loaded (force reload for development)
  try {
    ...
    console.log('factbook_loaded_for_chat', { trace_id: traceId, snippets: factbookService.getSnippetCount() });
  } catch (error) {
    console.warn('factbook_load_failed', { trace_id: traceId, error: error instanceof Error ? error.message : 'Unknown error' });
  }
